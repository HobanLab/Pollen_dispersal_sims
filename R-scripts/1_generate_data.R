...
load("R-scripts/Rdata/combined_list_params_ideal.Rdata") #loading in function parameters defined in defining_function_parameters.R script
#load("R-scripts/Rdata/combined_list_params_realistic.Rdata")
...
save(prop_capt_all_same, prop_capt_all_eligible, prop_capt_skewed, file="R-scripts/Rdata/alleles_capt_ideal_twopop.Rdata")

#saving realistic results to Rdata file
#save(prop_capt_all_same, prop_capt_all_eligible, prop_capt_skewed, file="../../R-scripts/Rdata/alleles_capt_realistic_twopop.Rdata")
