...
```{r}
#Ideal
#load("../../R-scripts/Rdata/alleles_capt_ideal_twopop.Rdata")
#Realistic
load("../../R-scripts/Rdata/alleles_capt_realistic_twopop.Rdata")
```
***
...
save(tidy_df, file="../../R-scripts/Rdata/tidy_df_realistic_twopop.Rdata")
```
